...
def get_gemini_classification(artist, title, mode="artist"):
    """
    Dual-layer metadata extraction engine running locally on your GTX 1650.
    """
    if mode == "genre":
        system_instruction = (
    ...
    # --- MODE: ARTIST (LOCAL DUAL-LAYER) ---
    raw_text = f"Artist field: {artist} | Title field: {title}"
    
    # Layer 1: Cover Verification Gate
    is_cover = False
    cover_instruction = (
    ...
    name_instruction = (
        ...
        "Rules:\n"
        "1. If a cover artist is explicitly named (e.g. 'Cover by Alia Adelia', 'Keroro Suika 【Cover】'), extract THAT person's name.\n"
